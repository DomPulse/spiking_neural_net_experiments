...
for e in range(1, epoch):
	...
	for b in range(batch_size):
		...
		is_right = train_labels[data_idx] == np.argmax(sum_output_fires)	
		num_right += is_right
		...
		if training and (train_labels[data_idx] != np.argmax(sum_output_fires)):
